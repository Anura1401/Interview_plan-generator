...
const NAV_ITEMS = [
    ...
    { id: 'profile', label: 'Uploaded Profile', icon: (<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>) }
]
    ...
    if (!report) {
        return (
            <main className='error-screen'>
                ...
                <p>Please make sure this plan exists and you have access permissions.</p>
                <button onClick={() => navigate("/")} className='button primary-button'>Back to Home</button>
            </main>
        )
    }
                ...
                <main className='interview-content'>
                    ...
                    {activeNav === 'profile' && (
                        <section className="profile-view">
                            <div className='content-header'>
                                <h2>Your Uploaded Profile</h2>
                            </div>
                            <div className='profile-card-content'>
                                {report.resume && (
                                    <div className='profile-section'>
                                        <h3>Resume Text</h3>
                                        <pre>{report.resume}</pre>
                                    </div>
                                )}
